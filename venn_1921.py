...
inf_bib = infra_bib[
    (infra_bib["Publication_year"] > 2018) & (infra_bib["Publication_year"] < 2022)
]
...
plt.savefig("Plots/Venn_AR_19to21.svg", dpi=300)
plt.savefig("Plots/Venn_AR_19to21.png", dpi=300)
