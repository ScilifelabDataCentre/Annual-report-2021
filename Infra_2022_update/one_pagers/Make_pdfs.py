...
from colour_science_2021 import SCILIFE_COLOURS_GREYS, SCILIFE_COLOURS
...
def generatePdf(Unit_name, Unit_data, Funding, current_year):
    ...
    # Compute and storage, CRISPR Functional Genomics, and Glycoproteomics dont have Platform directors
    ...
    elif Unit_name == "Glycoproteomics":
        Story.append(
            Paragraph(
                "<font name=Lato-B><b>Head(s) of unit: </b></font> {}".format(
                    (Unit_data["HOU"]).to_string(index=False),
        ...
        Story.append(
            Paragraph(
                "<font name=Lato-B><b>Platform director(s): </b></font> {}".format(
