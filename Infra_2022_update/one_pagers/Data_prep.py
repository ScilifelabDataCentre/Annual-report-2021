...
fac_map_input = pd.read_excel(
    "Data/Reporting Units 2021.xlsx",
...
### AFFILIATES
# Years of interest in 2022 - 2019-21
# We have 3 data files from OO for this (one for each year)

aff_2019_raw = pd.read_excel(
    "Data/Infrastructure Users 2019 QC.xlsx",
    sheet_name="Unit Users 2019",
    header=0,
    engine="openpyxl",
    keep_default_na=False,
)
...
aff_2020_raw = pd.read_excel(
    "Data/Infrastructure Users 2020 QC.xlsx",
...
aff_2021_raw = pd.read_excel(
    "Data/Infrastructure Users 2021 QC.xlsx",
...
aff_comb = pd.concat([affiliates_data_2019, affiliates_data_2020, affiliates_data_2021])
# print(aff_comb)
...
Unit_data.rename(
    columns={
        ...
        "Resource allocation 2021 Acadmia (national)": "RA_nat",
        "Resource allocation 2021 Acadmia (international)": "RA_int",
        "Resource allocation 2021 Internal tech. dev.": "RA_tech",
        "Resource allocation 2021 Industry": "RA_Ind",
        "Resource allocation 2021 Healthcare": "RA_Health",
        "Resource allocation 2021 Other gov. agencies": "RA_ogov",
        "User Fees 2021 Total (kSEK)": "UF_Tot",
        ...
        "User fees by sector 2021 Healthcare": "UF_sect_health",
        "User fees by sector 2021 Other gov. agencies": "UF_sect_othgov",
    },
    inplace=True,
)
...
Pubs_JIF_raw = pd.read_excel(
    "Data/infra_1921_comblab_mod.xlsx",
    sheet_name="Publications",
    header=0,
    engine="openpyxl",
    keep_default_na=False,
